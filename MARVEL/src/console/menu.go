...
// 	//Insertar usuario
// 	var d dto.Contacto
// 	// var d models.ModelContacto
// 	fmt.Println("Ingresa el nombre:")
// 	if scanner.Scan() {
// 		d.Nombre = scanner.Text()
// 	}
// 	fmt.Println("Ingresa el usuario:")
// 	if scanner.Scan() {
// 		d.Usuario = scanner.Text()
// 	}
// 	fmt.Println("Ingresa la contraseña:")
// 	if scanner.Scan() {
// 		d.Contraseña = scanner.Text()
// 	}
// 	// user := models.ModelContacto{Nombre: c.Nombre, Usuario: c.Usuario, Contraseña: c.Contraseña}
// 	_err := InsertarUser(d)
// 	if _err != nil {
